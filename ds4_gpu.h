...
int ds4_gpu_preallocate_async(uint64_t max_f16_elems, uint64_t max_scratch_bytes);
...
int ds4_gpu_matmul_q8_0_f16out_tensor(
...
int ds4_gpu_head_rms_norm_rope_tail_f16in_tensor(
        ds4_gpu_tensor       *out,
